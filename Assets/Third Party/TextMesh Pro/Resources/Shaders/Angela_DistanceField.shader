Shader "Custom/Wiggly_TMP_DistanceField"
{
	...
	Properties {
		...
		// Custom params start -------
		// DOODLE EFFECT
		_DoodleSize("Doodle Size", Range(2, 16)) = 7
		_DoodleSpeed("Doodle Speed", Range(1, 16)) = 5
		_DoodleFade("Doodle Fade", Range(0, 1)) = 0.445
	...
	SubShader {
		...
		Pass {
			...
			#pragma shader_feature __ BLEND_ON
